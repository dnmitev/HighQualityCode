namespace ComputerSystem.ComputerManufacturers
{
    ...
    public class HpFactory : AbstractComputerFactory
    {
        ...
        private const int DefaultPersonalComputerRamAmount = 2;
        private const int DefaultServerRamAmount = 32;
        private const int DefaultLaptopRamAmount = 4;
        ...
        private const int DefaultPersonalComputerHardDrivesCapacity = 500;
        private const int DefaultServerHardDrivesCapacity = 1000;
        private const int DefaultLaptopHardDrivesCapacity = 500;
        ...
        public override Laptop MakeLaptop()
        {
            ...
            var processor = new Cpu64Bit(DefaultLaptopCpuCoresCount, motherboard, randomNumberProvider);
        ...
        public override Server MakeServer()
        {
            ...
            var processor = new Cpu32Bit(DefaultServerCpuCoresCount, motherboard, randomNumberProvider);
